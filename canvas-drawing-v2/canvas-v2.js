document.addEventListener("DOMContentLoaded", (event) => {
    ...
    //canvas id for desktop. canvas2 is for mobile devices and tablets.
    ...
    document.addEventListener("keydown", (event) => {
        ...
        let yCoord = (y <= 475) ? y : 475; //I wrote this ternary operator for the y-coordinate. This way, a shape will not be drawn outside the visible area.

        //For width, height and radius, I wrote ternary operators in case a randomly generated dimension is too small to be seen with the naked eye. 
        ...
        length = Math.floor(Math.sqrt(Math.pow(xTwo - x, 2) + Math.pow(yTwo - y, 2)) ); 
        ...
        //The below hex color generator sometimes generates an invalid hex code (five characters after the hashtag instead of six). I wrote a ternary operator to address that outcome. If an invalid hex code is generated, then the shape will be a fallback color. The fallback color is a light gray.
    ...
    //This event listener is for mobile devices and tablets.
    box.addEventListener("touchend", (event) => {
        //Shape coordinates.
        x = Math.floor(Math.random()*500);
        y = Math.floor(Math.random()*300);
        let yCoord = (y <= 195) ? y : 195; //I wrote this ternary operator for the y-coordinate. This way, a shape will not be drawn outside the visible area.

        //For width, height and radius, I wrote ternary operators in case a randomly generated dimension is too small to be seen with the naked eye. 
        w = Math.floor(Math.random()*100);
        let width = (w < 20 ? 20 : w);
        h = Math.floor(Math.random()*100);
        let height = (h < 20 ? 20 : h);
    
        hex = '#'+ Math.floor(Math.random()*16777215).toString(16);
        let colorTwo = (hex.length === 7) ? hex : "#d3d3d3";

        context2.strokeStyle = colorTwo;
        context2.strokeRect(x, yCoord, width, height);
        console.log(`Lowercase ${event.key} draws a rectangle.\nColor is ${colorTwo}.\nCoordinates are ${x}, ${yCoord}.\nHeight is ${height} and width is ${width}.`);
    });
    ...
    line.addEventListener("touchend", (event) => {
        ...
        xTwo = x + Math.floor(Math.random()*50); //xTwo is the x-coordinate of the second lineTo() of the triangle. 
        yTwo = yCoord + Math.floor(Math.random()*50 + 5); //yTwo is the y-coordinate of the second lineTo() of the triangle. 
        ...
        context2.strokeStyle = colorTwo;
        context2.beginPath();
        context2.moveTo(x, yCoord);
        context2.lineTo(xTwo, yTwo); 
        context2.stroke(); 
        console.log(`Uppercase ${event.key} draws a line.\nColor is ${colorTwo}.\nStarting coordinates are ${x}, ${yCoord}.\nEnding coordinates are ${xTwo}, ${yTwo}.\nLine length is ${length}.`);
    });
    ...
    circle.addEventListener("touchend", (event) => {
        ...
        x = Math.floor(Math.random()*500);
        y = Math.floor(Math.random()*300);
        let yCoord = (y <= 245) ? y : 245; //I wrote this ternary operator for the y-coordinate. This way, a shape will not be drawn outside the visible area.
        ...
        context2.strokeStyle = colorTwo;
        context2.beginPath();
        context2.arc(x,yCoord,circleR,0,2*Math.PI);
        context2.stroke();
        console.log(`Number ${event.key} draws a circle.\nColor is ${colorTwo}.\nCoordinates are ${x}, ${yCoord}.\nRadius is ${circleR}.`);
    });
    ...
    triangle.addEventListener("touchend", (event) => {
        ...
        yTwo = yCoord + Math.floor(Math.random()*50 + 5); //yTwo is the y-coordinate of the second lineTo() of the triangle. 
        xThree = x + Math.floor(Math.random()*100); //xThree is the x-coordinate of the thrid lineTo() of the triangle.
        yThree = yCoord + Math.floor(Math.random()*50 + 5); //yThree is the y-coordinate of the third lineTo() of the triangle. 
